...
@section('contents')
	<div class="min-h-[calc(100vh-180px)] flex items-center justify-center p-4">
		<div
			class="max-w-md w-full bg-white border border-purple-900/10 rounded-2xl p-8 text-center shadow-lg space-y-6">
			<div
				class="w-16 h-16 bg-purple-100 text-purple-900 rounded-full flex items-center justify-center mx-auto shadow-inner">
