...
export const SubscriptionStatus = ({
	...
	return (
		<div className="space-y-6">
			...
			<div
				className="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
				<div className="flex items-center gap-4">
					...
					<div>
						...
						<p className="text-xs text-gray-500 mt-0.5">{t('manage_billing_stripe_desc')}</p>
					</div>
				</div>

				<a
					href={route('billing')}
					className="px-4 py-2.5 rounded-xl border border-purple-900/20 text-purple-900 hover:bg-purple-50 font-bold text-xs sm:text-sm transition-all duration-200 shadow-2xs hover:shadow-xs inline-flex items-center justify-center gap-2 shrink-0 cursor-pointer"
				>
					<span>{t('manage_billing_stripe')}</span>
